...
HD_PWD='C:/Vivado_Projects/ECGR 5146/Lab5_2_Bit_Comparator/Lab5_2_Bit_Comparator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log X_Bit_Compare_Structural.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source X_Bit_Compare_Structural.tcl
