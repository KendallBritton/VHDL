...
HD_PWD='C:/Vivado_Projects/ECGR 5146/Lab6_Counter/Lab6_Counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mod_M_Counter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mod_M_Counter.tcl
